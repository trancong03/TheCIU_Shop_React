        ...
        <nav className="bg-white">
            <div className="container flex justify-between items-center">
                <div className="md:hidden ">
                    <button onClick={() => setMenuOpen(!menuOpen)} className="text-[#5b5858cc] px-3 py-2">
                        <Menu />
                    </button>
                </div>
                ...
                <div className="hidden md:flex space-x-4 mb-2 gap-8 w-[60vw] ml-[20vw] justify-between">
                    <a
                        ...
                        className={`text-[#5b5858cc] text-lg  font-bold px-3 py-2 ${
                    ...
                    <a
                        ...
                        className={`text-[#5b5858cc] text-lg  font-bold px-3 py-2 ${
                            activeLink === 'collection' ? 'text-black' : 'hover:text-black'
                        }`}
                    >
                        Collection
                    </a>
                    <a
                        ...
                        className={`text-[#5b5858cc] text-lg  font-bold px-3 py-2 ${
                            activeLink === 'product' ? 'text-black' : 'hover:text-black'
                        }`}
                    >
                        Sản Phẩm
                    </a>
                    <a
                        ...
                        className={`text-[#5b5858cc] text-lg  font-bold px-3 py-2 ${
                            activeLink === 'services' ? 'text-black' : 'hover:text-black'
                        }`}
                    >
                        Event
                    </a>
                    <a
                        ...
                        className={`text-[#5b5858cc] text-lg  font-bold px-3 py-2 ${
                            activeLink === 'contact' ? 'text-black' : 'hover:text-black'
                        }`}
                    >
                        Giới Thiệu
                    </a>
                    <a
                        ...
                        className={`text-[#5b5858cc] text-lg  font-bold px-3 py-2 ${
                            activeLink === 'blog' ? 'text-black' : 'hover:text-black'
                        }`}
                    >
                        Blog
                    </a>
