...
export default function InfomationAccount({ user, setUserInfo }) {
  ...
  return (
      <div className="flex flex-col lg:flex-row p-6 lg:p-12 gap-6 bg-white min-h-screen max-w-screen-sm">
          <div className="flex-1 bg-white shadow-md rounded-lg p-6 h-fit">
              ...
              <div>
                  <div className='flex items-center justify-center gap-4'>
                      ...
                      <div className="mb-4 p-3 w-full  border border-gray-300 rounded-md text-lg text-slate-400  font-bold">
                          <label className="block text-sm text-slate-400  font-bold" htmlFor="name">
              ...
              {showLocationSelector && (
                  <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                      <div className="bg-white p-6 rounded-md w-[50vw] relative">
                          ...
                          <LocationSelector updatediachi={updateaddress} /> {/* Hiển thị component LocationSelector */}
                      </div>
                  </div>
              )}
              <br />
